...
namespace RoMan
{
	OpenGLShaderResourceDeclaration::OpenGLShaderResourceDeclaration(Type type, std::string& name, uint32_t count)
	...
	OpenGLShaderUniformDeclaration::Type OpenGLShaderUniformDeclaration::StringToType(std::string& type)
	{
	...
	OpenGLShaderUniformBufferDeclaration::OpenGLShaderUniformBufferDeclaration(const std::string& name, ShaderDomain domain)
		:m_Name(name), m_Domain(domain), m_Register(0), m_Size(0)
	{
