...
namespace RoMan
{
	...
	public:
		OpenGLShaderResourceDeclaration(Type type, std::string& name, uint32_t count);
	...
	public:
		...
		inline const ShaderStruct& GetShaderUniformStruct() const { RM_CORE_ASSERT(m_Struct, ""); return *m_Struct; }
